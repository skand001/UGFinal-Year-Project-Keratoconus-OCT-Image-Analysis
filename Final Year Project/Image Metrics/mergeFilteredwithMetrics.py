...
filtered_byImages = pd.read_csv('/mnt/data/MS39_Raw/CSO2/metadata/filtered_byImages.csv', low_memory=False).head(500)
metrics_df = pd.read_csv('/mnt/data/MS39_Raw/CSO2/metadata/metrics_test_20230302_193909.csv', low_memory=False).head(500)
...
stats_df = pd.DataFrame(columns=['FilePath', 
                                 'estimate_noise', 
...
stats_df.set_index('FilePath', inplace=True)
